...
class MyNodeMain {
	...
	public static void createLinkedList(Integer key1, Integer key2, Integer key3) {
		MyNode<Integer> myFirstNode = new MyNode<Integer>(key1);
		MyNode<Integer> mySecondNode = new MyNode<Integer>(key2);
		MyNode<Integer> myThirdNode = new MyNode<Integer>(key3);
		myFirstNode.setNext(mySecondNode);
		mySecondNode.setNext(myThirdNode);
		// check if linked list created
		boolean result = myFirstNode.getNext().equals(mySecondNode) && mySecondNode.getNext().equals(myThirdNode);
		System.out.println(
				"The linked list with nodes " + key1 + " , " + key2 + " and " + key3 + " has been created: " + result);
	}
	...
	// Use Case 3: Create linked list by appending 30 and 70 to 56 56 -> 30 -> 70
	...
	public static void createLinkedListAppend(Integer key1, Integer key2, Integer key3) {
	 ...
	 // Use Case 4: Insert 30 between 56 and 70 56 -> 30 -> 70
	...
	public static void insertLinkedListElement(Integer key1, Integer key2, Integer key3) {
		...
		boolean result = myLinkedList.head.equals(myFirstNode) && myLinkedList.head.getNext().equals(mySecondNode)
				&& myLinkedList.tail.equals(myThirdNode);
		System.out.println(
				key2 + " has been inserted in the linked list with nodes " + key1 + " and " + key3 + " : " + result);
	}
	...
	public static void popElementLinkedList(Integer key1, Integer key2, Integer key3) {
		...
		System.out.println(key1 + " has been popped out from the linked list with nodes " + key1 + ", " + key2 + " and "
				+ key3 + " : " + result);
	}
	...
	public static void deleteLastElementLinkedList(Integer key1, Integer key2, Integer key3) {
		...
		System.out.println(key3 + " has been popped out from the linked list with nodes " + key1 + ", " + key2 + " and "
				+ key3 + " : " + result);
	}
	 ...
	 */
	public static void insertAfterSearchLinkedList(Integer to_be_inserted, Integer search_key, Integer... args) {
		MyLinkedList myLinkedList = new MyLinkedList();
		// create linked list
		for (Integer i : args) {
			MyNode<Integer> myNode = new MyNode<>(i);
	...
	public static void main(String[] args) {
		...
		System.out.println("Today we shall perform basic operations" + "related to linked list.");
